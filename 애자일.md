...
1. Scrum
   1. 상호, 점진적 개발방법론
   1. 기능/개선점에 대한 우선 순위를 부여
   1. 개발 주기마다 실제 동작할 수 있는 결과를 제공
1. Kanban board
   1. 작업 관리
   1. 시각적 표시
1. XP (Extreme Programming)
   1. 비즈니스 상의 요구가 시시각각 변동이 심한 경우에 적합한 개발 방법
   1. 개발 문서 보다는 소스코드를, 조직적인 개발의 움직임 보다는 개개인의 책임과 용기에 중점
...
+-------------------------+-----------------------------+----------------------------------------------------------------------+
| Continuous Process      | Continuous Integration      | 개발은 누구에게나 최신 버전에서 수행되도록(이후 통합으로 인해 지연을 
|                         |                             | 야기하지 않도록).
...
|                         | System metaphor             | 구현 대상 시스템의 동작 방법을 개발자-고객 모두가 알 수 있는 
|                         |                             | 언어로 표현하도록(코드에서도)
+-------------------------+-----------------------------+----------------------------------------------------------------------+
