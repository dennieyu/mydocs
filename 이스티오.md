...
- Google Kubernetes Engine과 마이크로서비스 네트워크를 안전하게 관리하기 위한 개방형 시스템인 Istio 소개 영상

- [**Kubernetes, Istio, Spinnaker, Knative 발표 영상**](https://www.youtube.com/watch?v=113YLk31i_w&ab_channel=GoogleCloud)
