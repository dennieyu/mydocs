...
## 1. HDFS Cluster
 <img title="hdfs-cluster" src="./images/bigdata/hdfs-cluster-01.png" alt="hdfs-cluster" width="500px">

## 2. HDFS Architecture
 <img title="hdfs-architecture" src="./images/bigdata/hdfs-architecture-01.png" alt="hdfs-architecture" width="500px">
